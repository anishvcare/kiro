...
export default function LoginPage() {
  ...
  const { login, googleLogin, sendOTP, verifyOTP, isLoading, error, clearError } = useAuthStore();
  ...
  const handleGoogleLogin = async () => {
    // Google OAuth flow - would integrate with Google Sign-In SDK
    // For now, placeholder
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-teal-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Sign in to continue your FMGE preparation</p>
        </div>
